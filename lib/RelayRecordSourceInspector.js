...
var _require = require('./RelayStoreUtils'),
    formatStorageKey = _require.formatStorageKey;
...
var RelayRecordSourceInspector = function () {
  ...
  RelayRecordSourceInspector.prototype.getRoot = function getRoot() {
    ...
    if (root.viewer == null) {
      var viewerHandle = require('./getRelayHandleName')('viewer', 'viewer');
...
var RecordInspector = function () {
    ...
    require('fbjs/lib/forEachObject')(record, function (value, key) {
      ...
      if (typeof value === 'object' && value !== null) {
        if (value.hasOwnProperty(REF_KEY)) {
          (0, _defineProperty2['default'])(_this3, identifier, {
            configurable: true,
            enumerable: true,
            get: function get() {
  ...
  RecordInspector.prototype.getDataID = function getDataID() {
    return require('./RelayStaticRecord').getDataID(this._record);
  };
  ...
  RecordInspector.prototype.getFields = function getFields() {
    return (0, _keys2['default'])(this._record).sort();
  };
  ...
  RecordInspector.prototype.getType = function getType() {
    return require('./RelayStaticRecord').getType(this._record);
  };
  ...
  RecordInspector.prototype.getValue = function getValue(name, args) {
    ...
    return require('./RelayStaticRecord').getValue(this._record, storageKey);
  };
  ...
  RecordInspector.prototype.getLinkedRecord = function getLinkedRecord(name, args) {
    var storageKey = args ? formatStorageKey(name, args) : name;
    var linkedID = require('./RelayStaticRecord').getLinkedRecordID(this._record, storageKey);
  ...
  RecordInspector.prototype.getLinkedRecords = function getLinkedRecords(name, args) {
    ...
    var storageKey = args ? formatStorageKey(name, args) : name;
    var linkedIDs = require('./RelayStaticRecord').getLinkedRecordIDs(this._record, storageKey);
    if (linkedIDs == null) {
      return linkedIDs;
    }
...
var RecordSummary = function () {
  RecordSummary.createFromRecord = function createFromRecord(id, record) {
    var type = record ? require('./RelayStaticRecord').getType(record) : null;
