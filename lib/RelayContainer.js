...
var containerContextTypes = {
  relay: require('./RelayPropTypes').LegacyRelay,
...
function createContainerComponent(Component, spec) {
  ...
  var RelayContainer = function (_React$Component) {
    ...
    function RelayContainer(props, context) {
      ...
      require('fbjs/lib/invariant')(require('./isLegacyRelayContext')(relay), 'RelayContainer: `%s` was rendered with invalid Relay context `%s`. ' + 'Make sure the `relay` property on the React context conforms to the ' + '`RelayEnvironment` interface.', containerName, relay);
