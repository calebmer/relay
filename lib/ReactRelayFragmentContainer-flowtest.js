...
var _taggedTemplateLiteral3 = _interopRequireDefault(require('./babel-runtime/helpers/taggedTemplateLiteral'));

var _templateObject = (0, _taggedTemplateLiteral3['default'])([' fragment ReactRelayFragmentContainer-flowtest_Foo_viewer on Viewer { actor { id } } '], [' fragment ReactRelayFragmentContainer-flowtest_Foo_viewer on Viewer { actor { id } } ']),
    _templateObject2 = (0, _taggedTemplateLiteral3['default'])([' fragment ReactRelayFragmentContainer-flowtest_Bar_viewer on Viewer { actor { id } } '], [' fragment ReactRelayFragmentContainer-flowtest_Bar_viewer on Viewer { actor { id } } ']);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { 'default': obj }; }

var _require = require('./RelayCompat'),
...
var Foo = require('./ReactRelayFragmentContainer').createContainer(FooComponent, {
  viewer: graphql(_templateObject)
});
...
var Bar = require('./ReactRelayFragmentContainer').createContainer(BarComponent, {
  viewer: graphql(_templateObject2)
});
