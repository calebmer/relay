...
function getNode(taggedNode) {
  var fn = taggedNode.relayExperimental;
...
function getFragment(taggedNode) {
  ...
  require('fbjs/lib/invariant')(typeof fragment === 'object' && fragment !== null && fragment.kind === 'Fragment', 'RelayStaticGraphQLTag: Expected a fragment, got `%s`.', (0, _stringify2['default'])(fragment));
  return fragment;
}

function getOperation(taggedNode) {
  var operation = getNode(taggedNode);
  require('fbjs/lib/invariant')(typeof operation === 'object' && operation !== null && operation.kind === 'Batch', 'RelayStaticGraphQLTag: Expected an operation, got `%s`.', (0, _stringify2['default'])(operation));
  return operation;
}
