...
var RelayRecordSourceSelectorProxy = function (_RelayRecordSourcePro) {
  ...
  RelayRecordSourceSelectorProxy.prototype._getRootField = function _getRootField(fieldName, plural) {
    ...
    require('fbjs/lib/invariant')(field && field.kind === 'LinkedField', 'RelayRecordSourceSelectorProxy#getRootField(): Cannot find root ' + 'field `%s`, no such field is defined on GraphQL document `%s`.', fieldName, this._selector.node.name);
...
}(require('./RelayRecordSourceProxy'));
