...
function createContainerWithFragments(Component, fragments, taggedNode) {
  ...
  var Container = function (_React$Component) {
    ...
    function Container(props, context) {
      ...
      _this._refetch = function (variableProvider, finalVariables, callback, options) {
        var _assertRelayContext = assertRelayContext(_this.context.relay),
            environment = _assertRelayContext.environment,
            rootVariables = _assertRelayContext.variables;

        var fetchVariables = typeof variableProvider === 'function' ? variableProvider(_this._getFragmentVariables()) : variableProvider;
        fetchVariables = (0, _extends3['default'])({}, rootVariables, fetchVariables);
        var fragmentVariables = finalVariables ? (0, _extends3['default'])({}, rootVariables, finalVariables) : fetchVariables;
