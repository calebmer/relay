...
var RelayRecordProxy = function () {
  ...
  RelayRecordProxy.prototype.setValue = function setValue(value, name, args) {
    require('fbjs/lib/invariant')(value == null || typeof value !== 'object', 'RelayRecordProxy#setValue(): Expected a scalar value, got `%s`.', (0, _stringify2['default'])(value));
    var storageKey = args ? formatStorageKey(name, args) : name;
  ...
  RelayRecordProxy.prototype.setLinkedRecord = function setLinkedRecord(record, name, args) {
    require('fbjs/lib/invariant')(record instanceof RelayRecordProxy, 'RelayRecordProxy#setLinkedRecord(): Expected a record, got `%s`.', (0, _stringify2['default'])(record));
    var storageKey = args ? formatStorageKey(name, args) : name;
  ...
  RelayRecordProxy.prototype.setLinkedRecords = function setLinkedRecords(records, name, args) {
    require('fbjs/lib/invariant')(Array.isArray(records), 'RelayRecordProxy#setLinkedRecords(): Expected records to be an array, got `%s`.', (0, _stringify2['default'])(records));
    var storageKey = args ? formatStorageKey(name, args) : name;
