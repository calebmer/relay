...
var queryFiles = function () {
  var _ref = (0, _asyncToGenerator3['default'])(function* (baseDir, expression, filter) {
...
var watch = function () {
  var _ref2 = (0, _asyncToGenerator3['default'])(function* (baseDir, expression, callback) {
    var client = new PromiseClient();
    var watchResp = yield client.watchProject(baseDir);
...
var makeSubscription = function () {
  var _ref3 = (0, _asyncToGenerator3['default'])(function* (client, root, relativePath, expression, callback) {
...
var watchFiles = function () {
  var _ref4 = (0, _asyncToGenerator3['default'])(function* (baseDir, expression, filter, callback) {
...
var watchCompile = function () {
  var _ref5 = (0, _asyncToGenerator3['default'])(function* (baseDir, expression, filter, compile) {
    var compiling = false;
    var needsCompiling = false;
    var latestFiles = null;

    watchFiles(baseDir, expression, filter, function () {
      var _ref6 = (0, _asyncToGenerator3['default'])(function* (files) {
        needsCompiling = true;
        latestFiles = files;
        if (compiling) {
          return;
...
function updateFiles(files, filter, fileChanges) {
  ...
  fileChanges.forEach(function (_ref7) {
    var name = _ref7.name,
        exists = _ref7.exists;
...
var PromiseClient = function () {
  ...
  PromiseClient.prototype.command = function command() {
    ...
    return new _promise2['default'](function (resolve, reject) {
      _this2._client.command(args, function (error, response) {
        if (error) {
          reject(error);
        } else {
          resolve(response);
  ...
  PromiseClient.prototype.watchProject = function watchProject(baseDir) {
    var _this = this;

    return (0, _asyncToGenerator3['default'])(function* () {
      var resp = yield _this.command('watch-project', baseDir);
      if ('warning' in resp) {
