...
var _require = require('./RelayStaticSelector'),
    ...
    require('fbjs/lib/forEachObject')(selectors, function (selector, key) {
      ...
      if (selector == null) {
        ...
        if (resolver == null) {
          ...
          require('fbjs/lib/invariant')(resolver instanceof SelectorListResolver, 'RelayStaticFragmentSpecResolver: Expected prop `%s` to always be an array.', key);
        ...
        if (resolver == null) {
          ...
          require('fbjs/lib/invariant')(resolver instanceof SelectorResolver, 'RelayStaticFragmentSpecResolver: Expected prop `%s` to always be an object.', key);
